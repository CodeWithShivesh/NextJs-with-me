    ...
    return <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      ...
      <Spotlight className="-top-40 left-0 md:left-60 md:-top-20" fill="white"/>
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae nobis dolorum minima dolor nostrum quibusdam quasi inventore ut adipisci delectus tenetur cum mollitia odit, unde, dolore nemo aliquam nihil error vel, possimus et id perspiciatis. Quod laudantium, accusantium tempore accusamus debitis doloribus, sit sed, architecto quaerat quam quasi. Consequatur, deleniti!</p>
            <div className="mt-4">
                <Link href={"/coureses"}><Button borderRadius="1.75rem"
